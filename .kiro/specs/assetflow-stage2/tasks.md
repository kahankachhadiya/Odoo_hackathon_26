...
- [x] 6. Build the RegisterAssetModal component
  - [x] 6.1 Create `src/components/RegisterAssetModal.tsx`
...
- [x] 7. Build the AllocationHistory component
  - [x] 7.1 Create `src/components/AllocationHistory.tsx`
...
- [x] 8. Build Screen 4 — Asset Directory page
  - [x] 8.1 Create `src/pages/AssetDirectory.tsx`
...
- [x] 9. Build Screen 5 — Allocation & Transfer page
  - [x] 9.1 Create `src/pages/AllocationTransfer.tsx`
...
- [x] 10. Wire routes and navigation into App.tsx
  - [x] 10.1 Add Stage 2 routes to `src/App.tsx`
...
- [x] 11. Install testing dependencies and configure Vitest
